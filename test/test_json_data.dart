Map<String, dynamic> tCharacterDataWrapperDtoJSON = {
  "code": 200,
  "status": "Ok",
  ...
  "data": tCharacterDataContainerJSON
};

Map<String, dynamic> tDynamicCharacterWrapperSingleResultJSON = {
  "code": 200,
  "status": "Ok",
  "copyright": "© 2022 MARVEL",
  "attributionText": "Data provided by Marvel. © 2022 MARVEL",
        ...
        "urls": [
          {
            "type": "detail",
            "url":
                "http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=50c947f04e9d1b12a87d019cf84912e6"
          },
          {
            "type": "wiki",
            "url":
                "http://marvel.com/universe/3-D_Man_(Chandler)?utm_campaign=apiRef&utm_source=50c947f04e9d1b12a87d019cf84912e6"
          },
          {
            "type": "comiclink",
            "url":
...
Map<String, dynamic> tCharacterDataContainerJSON = {
  "offset": 0,
  "limit": 2,
  "total": 1562,
  "count": 2,
    ...
    },
    {
      ...
      "comics": {
        ...
        "items": [
          ...
          {"resourceURI": "http://gateway.marvel.com/v1/public/comics/40632", "name": "Hulk (2008) #53"},
          {"resourceURI": "http://gateway.marvel.com/v1/public/comics/40630", "name": "Hulk (2008) #54"},
          {"resourceURI": "http://gateway.marvel.com/v1/public/comics/40628", "name": "Hulk (2008) #55"}
        ],
        "returned": 4
      },
      "series": {
      ...
      "urls": [
        {
          "type": "detail",
          "url":
              "http://marvel.com/characters/76/a-bomb?utm_campaign=apiRef&utm_source=50c947f04e9d1b12a87d019cf84912e6"
        },
        {
          "type": "comiclink",
          "url":
              "http://marvel.com/comics/characters/1017100/a-bomb_has?utm_campaign=apiRef&utm_source=50c947f04e9d1b12a87d019cf84912e6"
        }
      ]
    }
  ]
...
Map<String, dynamic> tComicDataWrapperDtoJSON = {
  "code": 200,
  "status": "Ok",
  "copyright": "© 2022 MARVEL",
  "attributionText": "Data provided by Marvel. © 2022 MARVEL",
  "attributionHTML": "<a href=\"http://marvel.com\">Data provided by Marvel. © 2022 MARVEL</a>",
  "etag": "eadfda03544e56a2b32eb34d9ae5845aa867e584",
  "data": tComicDataContainerDtoJSON,
};

Map<String, dynamic> tComicDataContainerDtoJSON = {
  "offset": 0,
  "limit": 100,
  "total": 52596,
  "count": 100,
  "results": [
    {
      ...
      "urls": [
        {
          "type": "detail",
          "url":
              "http://marvel.com/comics/issue/82967/marvel_previews_2017?utm_campaign=apiRef&utm_source=50c947f04e9d1b12a87d019cf84912e6"
        }
      ],
      "series": {
      ...
      "stories": {
        ...
        "items": [
          {
            "resourceURI":
                "http://gateway.marvel.com/v1/public/stories/183698, name: cover from Marvel Previews (2017)",
            "type": "cover"
          },
          {
            "resourceURI":
                "http://gateway.marvel.com/v1/public/stories/183699, name: story from Marvel Previews (2017)",
            "type": "interiorStory"
          }
        ],
        "returned": 2
